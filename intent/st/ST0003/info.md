...
| ----- | ------------------------------------------------ | ---- | ----------- |
| WP-01 | Cut the 0.1.0 release                            | S    | Done        |
| WP-02 | Rule 4 -- two rulings and what follows           | M    | Not Started |
| WP-03 | Grow the spec library, and repair its text       | L    | Done        |
| WP-04 | Transport, and the conversion round behind it    | M    | Done        |
| WP-05 | Make scope durable: cdsync.json and spec_version | M    | Done        |
| WP-06 | Settle round three's outstanding rulings         | M    | Done        |
| WP-07 | Integrate the original four                      | M    | Done        |
| WP-08 | Housekeeping and small gaps                      | S    | Done        |
